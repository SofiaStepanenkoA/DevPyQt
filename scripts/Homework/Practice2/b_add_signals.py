...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.comboBox.currentIndexChanged.connect(self.ItemChangeCombo)  # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
        ...
        self.dateTimeEdit.dateTimeChanged.connect(self.DateTimeChanged)  # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
    ...
    def onPushButtonDateTimeEdit(self) -> None:
        self.plainTextEditLog.setPlainText(self.dateTimeEdit.time().toString())

    def onPushButtonClearLog(self) -> None:
        self.plainTextEditLog.clear()

    def ItemChangeCombo(self) -> None:
        self.plainTextEditLog.setPlainText(self.comboBox.currentText())
    def SpinBoxChanged(self) -> None:
        self.plainTextEditLog.setPlainText(self.spinBox.text())
    def DateTimeChanged(self) ->None:
